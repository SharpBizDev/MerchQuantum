  ...
  },
  {
    ...
    payloadOverrides: {
      imageTruth: {
        ...
        inferredMeaning: ["faith-centered message"],
        dominantTheme: "faith-centered",
      ...
      semanticRecord: {
        ...
        benefitCore: "Faith-centered copy with cautious wording because the slogan is incomplete.",
        likelyAudience: "faith-based buyers",
        styleOccasion: "faith-centered",
      ...
      canonicalLeadParagraphs: [
        "Faith-centered styling is clear, but the cropped slogan means this listing should stay cautious.",
  ...
  },
  {
    ...
    payloadOverrides: {
      imageTruth: {
        ...
        inferredMeaning: ["faith-centered"],
        dominantTheme: "faith-centered",
        likelyAudience: "faith-based buyers",
        likelyOccasion: "daily wear",
        uncertainty: [],
      ...
      canonicalLeadParagraphs: [
        "Bold faith-centered messaging keeps the visible slogan clear for shoppers.",
