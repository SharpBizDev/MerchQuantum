                            ...
                            <div className="flex flex-col gap-2 w-full">
                              <div className="flex items-center justify-between w-full">
                                ...
                                <button
                                  ...
                                  className={`text-[10px] leading-none font-sans font-normal px-1 py-0.5 flex items-center justify-center whitespace-nowrap shrink-0 border border-gray-600/50 rounded-sm text-gray-300 transition-colors duration-200 ${
