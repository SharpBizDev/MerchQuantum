          ...
          >
            ...
            <div className="flex min-w-0 flex-col gap-2 text-left lg:flex-row lg:items-start lg:justify-between lg:gap-4">
              <div className="min-w-0 shrink-0 pt-0.5">
                <div className="font-medium text-slate-900 dark:text-slate-100">Drag or click to add images</div>
              </div>
              <div className="relative min-w-0 flex-1 overflow-hidden px-0.5 pb-1.5 pt-0.5 text-[10px] font-medium text-slate-600 dark:text-slate-300">
                      ...
                      <div className="space-y-1.5">
                        <div className="relative">
                          ...
                          <div className={`group relative flex aspect-square w-full items-center justify-center overflow-visible rounded-lg border transition-all duration-500 ${previewFrameTone}`}>
                            ...
                            <div className="absolute inset-x-0 top-1 z-20 flex items-center justify-center gap-1">
