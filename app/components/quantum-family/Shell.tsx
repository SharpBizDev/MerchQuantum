...
export function QuantumFamilyShell({ children, spectralSlot, taskbarSlot }: QuantumFamilyShellProps) {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#020617] text-white">
      ...
      />
      <div className="relative mx-auto flex min-h-screen max-w-[1700px] flex-col px-3 py-3 sm:px-4 sm:py-4">
        <div className="relative flex min-h-[calc(100vh-1.5rem)] flex-1 flex-col overflow-hidden rounded-[32px] border border-white/10 bg-[rgba(15,23,42,0.62)] shadow-[0_40px_120px_-48px_rgba(15,23,42,0.95)] backdrop-blur-[20px] [backdrop-filter:blur(20px)_saturate(180%)]">
          ...
          {spectralSlot ? (
            <div className="pointer-events-none relative z-10 px-4 pb-2 pt-4 sm:px-6 sm:pt-5">
              {spectralSlot}
            </div>
          ) : null}
